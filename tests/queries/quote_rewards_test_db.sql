...
INSERT INTO orders (uid, sell_amount, buy_amount, fee_amount, kind, partially_fillable, class, owner, sell_token, buy_token)
VALUES ('\x01'::bytea, 95000000, 94000000000000000000, 5000000, 'sell', 'f', 'market', '\x0000000000000000000000000000000000000000'::bytea, '\x0000000000000000000000000000000000000000'::bytea, '\x0000000000000000000000000000000000000000'::bytea), -- normal sell market order
('\x02'::bytea, 101000000, 100000000000000000000, 5000000, 'buy', 'f', 'market', '\x0000000000000000000000000000000000000000'::bytea, '\x0000000000000000000000000000000000000000'::bytea, '\x0000000000000000000000000000000000000000'::bytea), -- normal buy market order
('\x03'::bytea, 100000000, 100000000000000000000, 0, 'sell', 't', 'limit', '\x0000000000000000000000000000000000000000'::bytea, '\x0000000000000000000000000000000000000000'::bytea, '\x0000000000000000000000000000000000000000'::bytea), -- partially fillable sell limit order
('\x04'::bytea, 100000000, 100000000000000000000, 0, 'buy', 't', 'limit', '\x0000000000000000000000000000000000000000'::bytea, '\x0000000000000000000000000000000000000000'::bytea, '\x0000000000000000000000000000000000000000'::bytea), -- partially fillable buy limit order
('\x05'::bytea, 100000000, 94000000000000000000, 0, 'sell', 'f', 'limit', '\x0000000000000000000000000000000000000000'::bytea, '\x0000000000000000000000000000000000000000'::bytea, '\x0000000000000000000000000000000000000000'::bytea), -- in market sell limit order
('\x06'::bytea, 106000000, 100000000000000000000, 0, 'buy', 'f', 'limit', '\x0000000000000000000000000000000000000000'::bytea, '\x0000000000000000000000000000000000000000'::bytea, '\x0000000000000000000000000000000000000000'::bytea); -- in market buy limit order
