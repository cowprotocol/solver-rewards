...
excluded_quotes as ( --noqa: PRS
    ...
    or (
        ...
        and (
            ...
            or
            -------------------------------------------------------- USDC/USDT0 ---------------------------------------------------
            (sell_token = '\xff970a61a04b1ca14834a43f5de4533ebddb5cc8' and buy_token = '\xfd086bc7cd5c481dcc9c85ebe478a1c0b69fcbb9')
            or
            (buy_token = '\xff970a61a04b1ca14834a43f5de4533ebddb5cc8' and sell_token = '\xfd086bc7cd5c481dcc9c85ebe478a1c0b69fcbb9')
            -----------------------------------------------------------------------------------------------------------------------
    )
    or (
        ...
        owner in (
            ...
            '\x696dec633216d2de851c004c2cdfc301c2817de2',
            '\xb10ed887880847abf6e7c5c48d75e4768aa64451',
            '\x133da62e590cdbddb595030e60fecf94a2d1b006',
