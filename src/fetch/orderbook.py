...
class OrderbookFetcher:
    ...
    def get_solver_transfers(self, accounting_period) -> DataFrame:
        """

        Returns
        -------
        solver_transfers : DataFrame
            accounting_period
            solver
            solver_name
            reward_target
            ...
            total_cow_transfer
        """
        query = "SELECT * FROM dune_sync_solver_transfers"
        barn, prod = cls._query_both_dbs(
            cow_reward_query_prod, cow_reward_query_barn, data_types
        )

    def get_protocol_transfer(self) -> DataFrame:
        """

        Returns
        -------
        protocol_transfers : DataFrame
            accounting_period
            protocol_fee_safe
            sum_protocol_fee_to_dao
            partner_fee_transfer_to_dao
            total_transfer_to_protocol
        """

    def get_partner_transfer(self) -> DataFrame:
        """

        Returns
        -------
        partner_transfers : DataFrame
            accounting_period
            partner_fee_recipient
            app_code
            partner_fee_native_transfer_to_partner
        """
